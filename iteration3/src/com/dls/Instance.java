...
public class Instance {
     ...
     */
    public int getNumberOfUniqueAssignments(){
     ...
     */
    public HashMap<Label, Integer> getLabelFrequencies(){
     ...
     */
    public HashMap<Label, Double> getLabelPercentages(){
     ...
     */
    public HashMap<Label, Double> getTheMostFrequentLabel(){
     ...
     */
    public Double getLabelDistributionEntropy(){
     ...
     */
    public ArrayList<Assignment> getAssignmentsOfUser(User user){
     ...
     */
    public Assignment addAssignment(User user) {
     ...
     */
    public Boolean checkAssignmentConsistencyOfUser(User user){
     ...
     * @return                          nothing
     */
    public void printLabelPercentages(){
        HashMap<Label, Double> labelPercentages = getLabelPercentages();
        for (Map.Entry<Label, Double> entry : labelPercentages.entrySet()){
     ...
     * @return                          nothing
     */
    public void printMostFrequentLabel(){
