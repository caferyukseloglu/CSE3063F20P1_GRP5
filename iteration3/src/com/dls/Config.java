...
//    }
     ...
     * @return                          nothing
     */
    public void setCurrentDatasetId(Integer datasetId){
     ...
     */
    public User addUser(int userId, String userName, String userType, String userPassword,Double userconsistencyCheckProbability){
        User user = new User(userId, userName, userType, userPassword,userconsistencyCheckProbability);
     ...
     */
    public Dataset addDataset(Integer datasetId, String datasetName, Integer maxNumberOfLabels, String inputPath){
