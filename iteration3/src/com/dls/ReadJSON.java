...
public class ReadJSON {
     ...
     * @return                          nothing
     */
    public void parseInstanceObject(JSONArray instanceList) {
     ...
     * @return                          nothing
     */
    public void parseLabelObject(JSONArray labelList) {
     ...
     * @return                          nothing
     */
    public static void parseUsers(JSONArray userList, Config config) {
        ...
        for (int i = 0; i < userListSize; i++) {
            ...
            Double userConsistencyCheckProbability =Double.parseDouble(usersObject.get("ConsistencyCheckProbability").toString());
            config.addUser(userId, userName, userType, userPassword,userConsistencyCheckProbability);
        }
    }
    /*
     ...
     * @return                          nothing
     */
    public static void parseDatasets(JSONArray datasetList, Config config) {
